...
- [Generative identity system](./superpowers/specs/2026-09-17-generative-identity-system-design.md)
...
- [`system-demo.html`](../system-demo.html) — universal component and construct demo.
- [`generative-system-demo.html`](../generative-system-demo.html) — seeded Three.js generative lab.
